...
class CustomReactionView @JvmOverloads constructor(
    ...
    init {
        ...
        emoji =
            styledAttrs.getString(R.styleable.CustomReactionView_customEmoji) ?: "\uD83D\uDE0A"

        contentPaint.run {
            color =
                styledAttrs.getColor(
                    R.styleable.CustomReactionView_customTextColor,
        ...
        selectedBgColor = styledAttrs.getColor(
            R.styleable.CustomReactionView_customSelectedColor,
            Color.parseColor("#464646")
        )

        unselectedBgColor = styledAttrs.getColor(
            R.styleable.CustomReactionView_customUnselectedColor,
